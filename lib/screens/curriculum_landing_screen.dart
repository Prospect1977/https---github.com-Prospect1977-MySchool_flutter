...
class _CurriculumLandingScreenState extends State<CurriculumLandingScreen> {
  ...
  void getData() {
    DioHelper.getData(url: 'Lessons', query: {}, lang: lang, token: token)
        .then((value) {
                        ...
                        child: DropdownButton(
                          ...
                          onChanged: (value) {
                            setState(() {
                              ...
                              SelectedSubjectDir = subjects.Subjects.firstWhere(
                                  (element) =>
                                      element.YearSubjectId == value).dir;
                            });
                          },
                          icon: Padding(
                              //Icon at tail, arrow bottom is default icon
