...
class TeacherViewsOvertimeScreen extends StatefulWidget {
  const TeacherViewsOvertimeScreen({Key key}) : super(key: key);

  @override
  State<TeacherViewsOvertimeScreen> createState() =>
      _TeacherViewsOvertimeScreenState();
}

class _TeacherViewsOvertimeScreenState
    extends State<TeacherViewsOvertimeScreen> {
  ...
  videosTraffic videosModel;
  quizzesTraffic quizzesModel;
  ...
  int lastMonth;
  int lastMonthYear;
  videosTraffic lineChartVideos;
  quizzesTraffic lineChartQuizzes;
  ...
  void GetChartData() {
    ...
    quizzesModel = null;
    DioHelper.getData(
            url: "Report_TeacherViews_Overtime_",
            query: {
              "TeacherId": teacherId,
              "FromDate": fromDate,
              "ToDate": toDate
      ...
      setState(() {
        ...
        videosModel =
            videosTraffic.fromJson(value.data["data"]["videosTraffic"]);
        quizzesModel =
            quizzesTraffic.fromJson(value.data["data"]["quizzesTraffic"]);
    ...
    return Scaffold(
      ...
      bottomNavigationBar:
          MediaQuery.of(context).orientation == Orientation.portrait
              ? TeacherViewsNavigationBar(PageIndex: pageIndex.LineChart.index)
              : null,
      body: RefreshIndicator(
          onRefresh: () async {
            GetChartData();
          },
          child: videosModel == null && quizzesModel == null
              ? Center(
                  ...
                  children: [
                    SingleChildScrollView(
                        ...
                        child: Row(children: [
                          ...
                          DateFilterButton(
                            caption: lang == "en" ? 'This Week' : "هذا الأسبوع",
                          ...
                          DateFilterButton(
                            caption: lang == "en" ? 'This Month' : "هذا الشهر",
                    ...
                    Expanded(
                      child: SingleChildScrollView(
                        ...
                        children: [
                          ...
                          ChartTitle(
                              title: lang == "en" ? "Videos" : "الفيديوهات"),
                          LineChartWidget(lineChartVideos.items),
                          ChartTitle(
                              title: lang == "en" ? "Quizzes" : "الإختبارات"),
                          LineChartWidget(lineChartQuizzes.items),
                        ],
                      )),
                    )
                  ],
