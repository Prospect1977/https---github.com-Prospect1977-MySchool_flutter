                      ...
                      child: Expanded(
                        child: Padding(
                          ...
                          child: PageView(
                            ...
                            children: MyQuiz.Questions.map((item) => Container(
                                  child: Column(
                                    crossAxisAlignment:
                                                              ...
                                                              children: [
                                                                Text(
                                                                    studentAnswers[
                                                                        ...
                                                                        .AnswerText,
                                                                    style: TextStyle(
                                                                        fontSize: studentAnswers[index].IsAnswerRight ==
                                                                                true
                                                                            ? 18
                                                                            : 16,
                                                                        color: studentAnswers[index].IsAnswerRight ==
                                                                                true
                                                                            ? Colors.green
                                                                            : Colors.black54)),
                                                                studentAnswers[index]
                                                                    ...
                                                                    ? Container(
                                                                        ...
                                                                        child: Text(
                                                                            widget.dir == "ltr"
                                                                                ? "This answer will be reviced by the teacher for approval!"
                                                                                : "سوف يتم مراجعة هذه الإجابة من قبل المُعلم للموافقة!",
                                                                            style:
                                                                    ...
                                                                    child: Row(
                                                                      children: [
                                                                        Icon(
                                                                            Icons
                                                                                .circle,
                                                                            size: studentAnswers[index].IsAnswerRight == null || studentAnswers[index].AnswerId == 0
                                                                                ? 10
                                                                                : (studentAnswers[index].IsAnswerRight == true ? (studentAnswers[index].AnswerId == item.answers[i].id ? 12 : 10) : (studentAnswers[index].AnswerId == item.answers[i].id ? 12 : 10)),
                                                                        ...
                                                                        Expanded(
                                                                          child:
                                                                            ...
                                                                            style: TextStyle(
                                                                                fontSize: studentAnswers[index].IsAnswerRight == null || studentAnswers[index].AnswerId == 0 ? 14 : (studentAnswers[index].IsAnswerRight == true ? (studentAnswers[index].AnswerId == item.answers[i].id ? 16 : 14) : (studentAnswers[index].AnswerId == item.answers[i].id ? 16 : 14)),
                                                                                color: studentAnswers[index].IsAnswerRight == null || studentAnswers[index].AnswerId == 0 ? Colors.black54 : (studentAnswers[index].IsAnswerRight == true ? (studentAnswers[index].AnswerId == item.answers[i].id ? Colors.green : Colors.black54) : (studentAnswers[index].AnswerId == item.answers[i].id ? Colors.red : Colors.black54)),
                                                                                fontWeight: studentAnswers[index].IsAnswerRight == null || studentAnswers[index].AnswerId == 0 ? FontWeight.normal : (studentAnswers[index].IsAnswerRight == true ? (studentAnswers[index].AnswerId == item.answers[i].id ? FontWeight.bold : FontWeight.normal) : (studentAnswers[index].AnswerId == item.answers[i].id ? FontWeight.bold : FontWeight.normal))),
                                                                          ),
                                                                        ),
                                                                      ],
                                                                    ),
