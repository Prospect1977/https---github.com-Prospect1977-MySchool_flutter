...
class StudentFavoritesAllScreen extends StatefulWidget {
  StudentFavoritesAllScreen({this.StudentId, Key key}) : super(key: key);
  int StudentId;

  @override
  State<StudentFavoritesAllScreen> createState() =>
      _StudentFavoritesAllScreenState();
}

class _StudentFavoritesAllScreenState extends State<StudentFavoritesAllScreen> {
  ...
  void getData() async {
    ...
    await DioHelper.getData(
      url: 'StudentFavoriteSessions/GetAllFavorites',
      query: {
                                                            ...
                                                            child: Stack(
                                                                children: [
                                                                  FractionallySizedBox(
                                                                    widthFactor: item.videosProgress >
                                                                            100
                                                                        ? 1
                                                                        : item.videosProgress /
                                                                            100,
