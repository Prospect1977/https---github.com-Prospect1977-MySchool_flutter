...
import 'package:my_school/models/teachers_viewsPerLesson_model.dart';
...
class TeacherViewsPerLessonScreen extends StatefulWidget {
  const TeacherViewsPerLessonScreen({Key key}) : super(key: key);

  @override
  State<TeacherViewsPerLessonScreen> createState() =>
      _TeacherViewsPerLessonScreenState();
}

class _TeacherViewsPerLessonScreenState
    extends State<TeacherViewsPerLessonScreen> {
  var lang = CacheHelper.getData(key: "lang");
  var teacherId = CacheHelper.getData(key: "teacherId");
  var token = CacheHelper.getData(key: "token");
  DateTime getDate(DateTime d) => DateTime(d.year, d.month, d.day);
  int maxCount;
  TeacherViewsPerLessonModel model;
  ...
  void GetChartData() {
    model = null;
    DioHelper.getData(
            url: "Report_TeacherViewsPerSubject",
            query: {
              "TeacherId": teacherId,
              "FromDate": fromDate,
              "ToDate": toDate
      ...
      setState(() {
        ...
        model = TeacherViewsPerLessonModel.fromJson(value.data["data"]);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar:
          TeacherViewsNavigationBar(PageIndex: pageIndex.ViewsPerLesson.index),
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  ...
                  style: TextStyle(
                      color: defaultColor.withOpacity(0.8), fontSize: 14),
